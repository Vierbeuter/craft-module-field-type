...
/**
 * The Textarea class is a subfield implementation of type `textarea`.
 *
 * @package Vierbeuter\Craft\Field\Subfield
 *
 * @see \Vierbeuter\Craft\Field\Subfield::TYPE_TEXTAREA
 */
class Textarea extends Subfield
{
    ...
    {
        parent::__construct(static::TYPE_TEXTAREA, $label, $key, $suffix, $config);
    }
