...
/**
 * The Color class is a subfield implementation of type `color`.
 *
 * @package Vierbeuter\Craft\Field\Subfield
 *
 * @see \Vierbeuter\Craft\Field\Subfield::TYPE_COLOR
 */
class Color extends Subfield
{
    ...
    {
        parent::__construct(static::TYPE_COLOR, $label, $key, $config, $rules);
    }
