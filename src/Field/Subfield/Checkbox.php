...
/**
 * The Checkbox class is a subfield implementation of type `checkbox`.
 *
 * @package Vierbeuter\Craft\Field\Subfield
 *
 * @see \Vierbeuter\Craft\Field\Subfield::TYPE_CHECKBOX
 */
class Checkbox extends Subfield
{
    ...
    {
        parent::__construct(static::TYPE_CHECKBOX, $label, $key, $suffix, $config);
    }
    ...
    {
        $config['checked'] = !empty($value->{$this->key});
